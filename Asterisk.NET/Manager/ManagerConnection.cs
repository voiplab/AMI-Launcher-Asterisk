...
namespace AsterNET.Manager
{
	...
	public delegate void AgentCallbackLoginEventHandler(object sender, AgentCallbackLoginEvent e);

	public delegate void AgentCallbackLogoffEventHandler(object sender, AgentCallbackLogoffEvent e);

	public delegate void AgentCalledEventHandler(object sender, AgentCalledEvent e);

	public delegate void AgentCompleteEventHandler(object sender, AgentCompleteEvent e);

	public delegate void AgentConnectEventHandler(object sender, AgentConnectEvent e);

	public delegate void AgentDumpEventHandler(object sender, AgentDumpEvent e);

	public delegate void AgentLoginEventHandler(object sender, AgentLoginEvent e);

	public delegate void AgentLogoffEventHandler(object sender, AgentLogoffEvent e);

	public delegate void AgentsCompleteEventHandler(object sender, AgentsCompleteEvent e);

	public delegate void AgentsEventHandler(object sender, AgentsEvent e);

	public delegate void AlarmClearEventHandler(object sender, AlarmClearEvent e);

	public delegate void AlarmEventHandler(object sender, AlarmEvent e);

	public delegate void BridgeEventHandler(object sender, BridgeEvent e);

	public delegate void CdrEventHandler(object sender, CdrEvent e);

	public delegate void DBGetResponseEventHandler(object sender, DBGetResponseEvent e);

	public delegate void DialEventHandler(object sender, DialEvent e);

	public delegate void DTMFEventHandler(object sender, DTMFEvent e);

	public delegate void DNDStateEventHandler(object sender, DNDStateEvent e);

	public delegate void ExtensionStatusEventHandler(object sender, ExtensionStatusEvent e);

	public delegate void HangupEventHandler(object sender, HangupEvent e);

	public delegate void HoldedCallEventHandler(object sender, HoldedCallEvent e);

	public delegate void HoldEventHandler(object sender, HoldEvent e);

	public delegate void JoinEventHandler(object sender, JoinEvent e);

	public delegate void LeaveEventHandler(object sender, LeaveEvent e);

	public delegate void LinkEventHandler(object sender, LinkEvent e);

	public delegate void LogChannelEventHandler(object sender, LogChannelEvent e);

	public delegate void MeetMeJoinEventHandler(object sender, MeetmeJoinEvent e);

	public delegate void MeetMeLeaveEventHandler(object sender, MeetmeLeaveEvent e);

	public delegate void MeetMeTalkingEventHandler(object sender, MeetmeTalkingEvent e);

	public delegate void MessageWaitingEventHandler(object sender, MessageWaitingEvent e);

	public delegate void NewCallerIdEventHandler(object sender, NewCallerIdEvent e);

	public delegate void NewChannelEventHandler(object sender, NewChannelEvent e);

	public delegate void NewExtenEventHandler(object sender, NewExtenEvent e);

	public delegate void NewStateEventHandler(object sender, NewStateEvent e);

	public delegate void OriginateResponseEventHandler(object sender, OriginateResponseEvent e);

	public delegate void ParkedCallEventHandler(object sender, ParkedCallEvent e);

	public delegate void ParkedCallGiveUpEventHandler(object sender, ParkedCallGiveUpEvent e);

	public delegate void ParkedCallsCompleteEventHandler(object sender, ParkedCallsCompleteEvent e);

	public delegate void ParkedCallTimeOutEventHandler(object sender, ParkedCallTimeOutEvent e);

	public delegate void PeerEntryEventHandler(object sender, PeerEntryEvent e);

	public delegate void PeerlistCompleteEventHandler(object sender, PeerlistCompleteEvent e);

	public delegate void PeerStatusEventHandler(object sender, PeerStatusEvent e);

	public delegate void QueueEntryEventHandler(object sender, QueueEntryEvent e);

	public delegate void QueueMemberAddedEventHandler(object sender, QueueMemberAddedEvent e);

	public delegate void QueueMemberEventHandler(object sender, QueueMemberEvent e);

	public delegate void QueueMemberPausedEventHandler(object sender, QueueMemberPausedEvent e);

	public delegate void QueueMemberRemovedEventHandler(object sender, QueueMemberRemovedEvent e);

	public delegate void QueueMemberStatusEventHandler(object sender, QueueMemberStatusEvent e);

	public delegate void QueueParamsEventHandler(object sender, QueueParamsEvent e);

	public delegate void QueueStatusCompleteEventHandler(object sender, QueueStatusCompleteEvent e);

	public delegate void RegistryEventHandler(object sender, RegistryEvent e);

	public delegate void RenameEventHandler(object sender, RenameEvent e);

	public delegate void TransferEventHandler(object sender, TransferEvent e);

	public delegate void StatusCompleteEventHandler(object sender, StatusCompleteEvent e);

	public delegate void StatusEventHandler(object sender, StatusEvent e);

	public delegate void UnholdEventHandler(object sender, UnholdEvent e);

	public delegate void UnlinkEventHandler(object sender, UnlinkEvent e);

	public delegate void UnparkedCallEventHandler(object sender, UnparkedCallEvent e);

	public delegate void UserEventHandler(object sender, UserEvent e);

	public delegate void QueueCallerAbandonEventHandler(object sender, QueueCallerAbandonEvent e);

	public delegate void ZapShowChannelsCompleteEventHandler(object sender, ZapShowChannelsCompleteEvent e);

	public delegate void ZapShowChannelsEventHandler(object sender, ZapShowChannelsEvent e);

	public delegate void ConnectionStateEventHandler(object sender, ConnectionStateEvent e);

	public delegate void VarSetEventHandler(object sender, VarSetEvent e);

	public delegate void AGIExecHandler(object sender, AGIExecEvent e);

	public delegate void ConfbridgeStartEventHandler(object sender, ConfbridgeStartEvent e);

	public delegate void ConfbridgeJoinEventHandler(object sender, ConfbridgeJoinEvent e);

	public delegate void ConfbridgeLeaveEventHandler(object sender, ConfbridgeLeaveEvent e);

	public delegate void ConfbridgeEndEventHandler(object sender, ConfbridgeEndEvent e);

	public delegate void ConfbridgeTalkingEventHandler(object sender, ConfbridgeTalkingEvent e);

	public delegate void FailedACLEventHandler(object sender, FailedACLEvent e);

	public delegate void AttendedTransferEventHandler(object sender, AttendedTransferEvent e);

	public delegate void BlindTransferEventHandler(object sender, BlindTransferEvent e);

	public delegate void BridgeCreateEventHandler(object sender, BridgeCreateEvent e);

	public delegate void BridgeDestroyEventHandler(object sender, BridgeDestroyEvent e);

	public delegate void BridgeEnterEventHandler(object sender, BridgeEnterEvent e);

	public delegate void BridgeLeaveEventHandler(object sender, BridgeLeaveEvent e);
	...
	public class ManagerConnection
	{
		...
		private readonly Dictionary<int, IResponseHandler> responseHandlers;
		private readonly Dictionary<int, IResponseHandler> pingHandlers;
		...
		private readonly Dictionary<int, ConstructorInfo> registeredEventClasses;
		private readonly Dictionary<int, int> registeredEventHandlers;
		...
		/// <summary>
		///     A PeerEntry is triggered in response to a SIPPeersAction or SIPShowPeerAction and contains information about a
		///     peer.<br />
		/// </summary>
		public event PeerEntryEventHandler PeerEntry;

		/// <summary>
		///     A PeerlistComplete is triggered after the details of all peers has been reported in response to an SIPPeersAction
		///     or SIPShowPeerAction.<br />
		/// </summary>
		...
		/// <summary>
		///     A QueueEntryEvent is triggered in response to a QueueStatusAction and contains information about an entry in a
		///     queue.
		/// </summary>
		...
		/// <summary>
		///     A QueueMemberEvent is triggered in response to a QueueStatusAction and contains information about a member of a
		///     queue.
		/// </summary>
		...
		/// <summary>
		///     A QueueStatusCompleteEvent is triggered after the state of all queues has been reported in response to a
		///     QueueStatusAction.
		/// </summary>
		...
		/// <summary>
		///     An UnlinkEvent is triggered when a link between two voice channels is discontinued, for example, just before call
		///     completion.
		/// </summary>
		...
		/// <summary>
		///     A ZapShowChannelsCompleteEvent is triggered after the state of all zap channels has been reported in response to a
		...
		/// <summary>
		///     This event is sent when a user joins a conference - either one already in progress or as the first user to join a
		///     newly instantiated bridge.
		/// </summary>
		...
		public ManagerConnection()
		{
			...
			internalEvent += internalEventHandler;
		}
		...
		{
			get => reconnectIntervalMax;
			set => reconnectIntervalMax = value;
		}

		#region CallerThread

		internal Thread CallerThread { get; }
			...
			if (registeredEventHandlers.ContainsKey(eventHash))
				switch (registeredEventHandlers[eventHash])
				{
					...
					case 2:
						if (AgentCalled != null)
						{
							AgentCalled(this, (AgentCalledEvent) e);
							return;
						}
					...
					case 3:
						...
						{
							AgentComplete(this, (AgentCompleteEvent) e);
							return;
						}
					...
					case 4:
						...
						{
							AgentConnect(this, (AgentConnectEvent) e);
							return;
						}
					...
					case 5:
						if (AgentDump != null)
						{
							AgentDump(this, (AgentDumpEvent) e);
							return;
						}
					...
					case 6:
						if (AgentLogin != null)
						{
							AgentLogin(this, (AgentLoginEvent) e);
							return;
						}
					...
					case 7:
						if (AgentLogoff != null)
						{
							AgentLogoff(this, (AgentLogoffEvent) e);
							return;
						}
					...
					case 62:
						...
						break;
					case 63:
						if (Bridge != null) Bridge(this, (BridgeEvent) e);
						break;
					case 64:
						if (Transfer != null) Transfer(this, (TransferEvent) e);
						break;
					case 65:
						if (DTMF != null) DTMF(this, (DTMFEvent) e);
						break;
					case 70:
						if (VarSet != null) VarSet(this, (VarSetEvent) e);
						break;
					case 80:
						if (AGIExec != null) AGIExec(this, (AGIExecEvent) e);
						break;
					case 81:
						if (ConfbridgeStart != null) ConfbridgeStart(this, (ConfbridgeStartEvent) e);
						break;
					case 82:
						if (ConfbridgeJoin != null) ConfbridgeJoin(this, (ConfbridgeJoinEvent) e);
						break;
					case 83:
						if (ConfbridgeLeave != null) ConfbridgeLeave(this, (ConfbridgeLeaveEvent) e);
						break;
					case 84:
						if (ConfbridgeEnd != null) ConfbridgeEnd(this, (ConfbridgeEndEvent) e);
						break;
					case 85:
						if (ConfbridgeTalking != null) ConfbridgeTalking(this, (ConfbridgeTalkingEvent) e);
						break;
					case 86:
						if (FailedACL != null) FailedACL(this, (FailedACLEvent) e);
						break;
					case 87:
						if (AttendedTransfer != null) AttendedTransfer(this, (AttendedTransferEvent) e);
						break;
					case 88:
						if (BridgeCreate != null) BridgeCreate(this, (BridgeCreateEvent) e);
						break;
					case 89:
						if (BridgeDestroy != null) BridgeDestroy(this, (BridgeDestroyEvent) e);
						break;
					case 90:
						if (BridgeEnter != null) BridgeEnter(this, (BridgeEnterEvent) e);
						break;
					case 91:
						if (BridgeLeave != null) BridgeLeave(this, (BridgeLeaveEvent) e);
						break;
					case 92:
						if (BlindTransfer != null) BlindTransfer(this, (BlindTransferEvent) e);
						break;
					default:
		...
		/// <summary>
		///     If this property set to <b>true</b> then ManagerConnection send all unassigned events to UnhandledEvent handler,
		///     <br />
		...
		///     Default is 2000.
		/// </summary>
		public int DefaultResponseTimeout { get; set; } = 2000;
		...
		///     Default is 5000.
		/// </summary>
		public int DefaultEventTimeout { get; set; } = 5000;
		...
		///     Default is false.
		/// </summary>
		public bool KeepAliveAfterAuthenticationFailure { set; get; } = false;
		...
		///     This is set to true after successful login and to false after logoff or after an authentication failure when
		...
		public AsteriskVersion AsteriskVersion { get; private set; }
		...
		///     Waits until the protocol identifier is received. This is checked every sleepTime ms but not longer than timeout ms
		///     in total.<br />
		///     Sends a ChallengeAction requesting a challenge for authType MD5.<br />
		///     When the ChallengeResponse is received a LoginAction is sent using the calculated key (MD5 hash of the password
		///     appended to the received challenge).<br />
		/// </summary>
		/// <param name="timeout">the maximum time to wait for the protocol identifier (in ms)</param>
		/// <throws>
		///     AuthenticationFailedException if username or password are incorrect and the login action returns an error or if the
		///     MD5
		...
		private void login(int timeout)
		{
			...
			do
			{
				if (connect()) Thread.Sleep(10 * SleepTime); // 200 milliseconds delay
				try
				{
			...
			ManagerResponse response = SendAction(challengeAction, DefaultResponseTimeout * 2);
			if (response is ChallengeResponse)
			{
				...
				try
				{
					MD5Support md = MD5Support.GetInstance();
					if (challenge != null)
						md.Update(Encoding.UTF8.GetBytes(challenge));
					if (Password != null)
						md.Update(Encoding.UTF8.GetBytes(Password));
				...
				LoginAction loginAction = new LoginAction(Username, "MD5", key);
				ManagerResponse loginResponse = SendAction(loginAction);
				if (loginResponse is ManagerError)
				{
					disconnect(true);
			...
			{
				throw new ManagerException("Unknown response during login to Asterisk - " + response.GetType().Name +
		...
		protected internal AsteriskVersion determineVersion()
		{
			...
			response = SendAction(new CommandAction("core show version"), DefaultResponseTimeout * 2);
			if (response is CommandResponse)
				foreach (string line in ((CommandResponse) response).Result)
			...
			ManagerResponse showVersionFilesResponse =
				SendAction(new CommandAction("show version files"), DefaultResponseTimeout * 2);
			if (showVersionFilesResponse is CommandResponse)
			{
				IList showVersionFilesResult = ((CommandResponse) showVersionFilesResponse).Result;
		...
		protected internal bool connect()
		{
			...
			if (startReader) mrReaderThread.Start();
		...
		{
			return GetHashCode() + "_" + actionIdCount++;
		}
		...
		public ResponseEvents SendEventGeneratingAction(ManagerActionEvent action, int timeout)
		{
			if (action == null)
				throw new ArgumentException("Unable to send action: action is null.");
			if (action.ActionCompleteEventClass() == null)
				throw new ArgumentException("Unable to send action: ActionCompleteEventClass is null.");
			if (!typeof(ResponseEvent).IsAssignableFrom(action.ActionCompleteEventClass()))
			...
			throw new EventTimeoutException("Timeout waiting for response or response events to " + action.Action,
				handler.ResponseEvents);
		}
		...
		private SendToAsteriskDelegate sa;
		...
		public string BuildAction(ManagerAction action, string internalActionId)
		{
			...
			if (typeof(ProxyAction).IsAssignableFrom(action.GetType()))
			...
			if (actionVar != null && actionVar.GetVariables().Count > 0)
				sb.Append(string.Concat("Variable: ", Helper.JoinVariables(actionVar.GetVariables(), VAR_DELIMITER, "="),
					Common.LINE_SEPARATOR));
		...
		///     received. The response is dispatched to the associated <see cref="IManagerResponseHandler" />
		...
		internal void DispatchEvent(ManagerEvent e)
		{
			...
			if (e is ResponseEvent)
			{
				...
				if (!string.IsNullOrEmpty(responseEvent.ActionId) && !string.IsNullOrEmpty(responseEvent.InternalActionId))
				{
					ResponseEventHandler eventHandler =
						(ResponseEventHandler) GetResponseEventHandler(responseEvent.InternalActionId.GetHashCode());
			...
			if (e is ConnectEvent)
			{
				...
				{
					protocolIdentifier = string.IsNullOrEmpty(protocol) ? "Empty" : protocol;
#if LOGGER
		...
		private void fireEvent(ManagerEvent e)
		{
			if (enableEvents && internalEvent != null)
				if (UseASyncEvents)
					internalEvent.BeginInvoke(this, e, eventComplete, null);
				else
